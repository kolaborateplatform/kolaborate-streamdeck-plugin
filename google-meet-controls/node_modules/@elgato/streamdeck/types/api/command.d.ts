...
import type { ActionIdentifier, State } from "./events";
 ...
 */
export type OpenUrl = CommandBaseWithPayload<"openUrl", {
    /**
     * URL to open.
     */
    url: string;
 ...
 */
export type LogMessage = CommandBaseWithPayload<"logMessage", {
    /**
     * Message to log.
     */
    message: string;
 ...
 */
export type SetTitle = ContextualizedCommandWithPayload<"setTitle", {
    /**
 ...
 */
export type SetImage = ContextualizedCommandWithPayload<"setImage", {
    /**
 ...
 */
export type SetFeedbackLayout = ContextualizedCommandWithPayload<"setFeedbackLayout", {
    /**
 ...
 */
export type SetState = ContextualizedCommandWithPayload<"setState", {
    /**
 ...
 */
export type SetTriggerDescription = ContextualizedCommandWithPayload<"setTriggerDescription", {
    /**
 ...
 */
export type SwitchToProfile = ContextualizedCommandWithPayload<"switchToProfile", {
    /**
 ...
 */
export type PluginCommand = GetGlobalSettings | GetSettings | LogMessage | OpenUrl | SendToPropertyInspector | SetFeedback | SetFeedbackLayout | SetGlobalSettings | SetImage | SetSettings | SetState | SetTitle | SetTriggerDescription | ShowAlert | ShowOk | SwitchToProfile;
/**
