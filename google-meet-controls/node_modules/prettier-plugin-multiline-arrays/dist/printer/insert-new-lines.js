...
const leading_new_line_1 = require("./leading-new-line");
                ...
                (0, child_docs_1.walkDoc)(indentedContent, debug, (currentDoc, commaParents, commaChildIndex) => {
                    ...
                    if ((0, doc_1.isDocCommand)(currentDoc) && currentDoc.type === 'if-break') {
                        ...
                        if (debug) {
                            ...
                            console.info((0, doc_1.isDocCommand)(firstPart), (0, doc_1.isDocCommand)(secondPart), firstPart.type === 'line', firstPart.hard, secondPart.type === 'break-parent');
                        }
...
function printWithMultilineArrays(originalFormattedOutput, path, inputOptions, debug) {
    ...
    if (node &&
        ...
        const includesLeadingNewline = (0, leading_new_line_1.containsLeadingNewline)(node.loc, 'arguments' in node
            ? node.arguments
            : 'params' in node
                ? node.params
                : node.elements, splitOriginalText, debug);
        ...
        const newDoc = (0, supported_node_types_1.isArgumentsLikeNode)(node)
            ? (0, insert_new_lines_into_arguments_1.insertLinesIntoArguments)(originalFormattedOutput, manualWrap, lineCounts, wrapThreshold, includesTrailingComma, debug)
            : insertLinesIntoArray(originalFormattedOutput, manualWrap, lineCounts, wrapThreshold, debug);
        return newDoc;
    }
